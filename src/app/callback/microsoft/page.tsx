        ...
        <div className="min-h-screen bg-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-6 sm:space-y-8 p-6 sm:p-8 text-center">
                ...
                {status === 'success' && (
                    <div className="space-y-3 sm:space-y-4">
                        <div
                            className="w-7 h-7 sm:w-8 sm:h-8 mx-auto bg-green-100 rounded-full flex items-center justify-center">
                            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" fill="currentColor"
                                 viewBox="0 0 20 20">
                ...
                {status === 'error' && (
                    <div className="space-y-3 sm:space-y-4">
                        <div
                            className="w-7 h-7 sm:w-8 sm:h-8 mx-auto bg-red-100 rounded-full flex items-center justify-center">
